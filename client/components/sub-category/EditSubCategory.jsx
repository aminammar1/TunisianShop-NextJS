            ...
            <form className='my-3 grid gap-3' onSubmit={handleSubmitSubCategory}>
                            ...
                            <div className='flex flex-wrap gap-2'>
                                {
                                    subcategory.category.map((categoryId,index)=>{
                                        ...
                                        return(
                                            <div key={categoryId +"selectedValue"} className='bg-white shadow-md px-1 m-1 flex items-center gap-2'>
                                                {category ? category.name : "Unknown Category"}
                                                <div className='cursor-pointer hover:text-red-600' onClick={()=>handleRemoveCategorySelected(categoryId)}>
                                                    <IoClose size={20}/>
                                                </div>
                                            </div>
                                        )
                    ...
                    <button
                        className={`px-4 py-2 border
                            ${subcategory?.name && subcategory?.image && subcategory?.category[0] ? "bg-primary-200 hover:bg-primary-100" : "bg-gray-200"}    
                            font-semibold
                        `}
                    >
                        Submit
