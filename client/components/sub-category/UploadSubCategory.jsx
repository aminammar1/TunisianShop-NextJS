...
export default function UploadSubCategory({ close, fetchData }) {
            ...
            <form className='my-3 grid gap-3' onSubmit={handleSubmitSubCategory}>
                    <div className='grid gap-1'>
                        ...
                        <input 
                            ...
                            className='p-3 bg-gray-50 border outline-none focus-within:border-primary-200 rounded focus:ring-1 ring-red-600'
                        />
                    </div>
                    <div className='grid gap-1'>
                        <p>Image</p>
                        <div className='flex flex-col lg:flex-row items-center gap-3'>
                            <div className='border h-36 w-full lg:w-36 bg-gray-50 flex items-center justify-center'>
                                {
                                    !subcategory.image ? (
                        ...
                        <div className='border focus-within:border-primary-200 rounded'>
                            ...
                            <select
                                ...
                                onChange={(e)=>{
                                    ...
                                    console.log("Selected Category Details:", categoryDetails);
                                    setSubCategory((preve)=>{
                                        return{
                                            ...preve,
                    ...
                    <button
                        className={`px-4 py-2 border
                            ${subcategory?.name && subcategory?.image && subcategory?.category[0] ? "bg-red-600 hover:bg-red-900" : "bg-red-600"}    
                            text-white
                        `}
                    >
