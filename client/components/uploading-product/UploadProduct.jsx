          ...
          <div>
            ...
            <div>
              <label
                ...
                className="bg-gray-50 h-24 border rounded flex justify-center items-center cursor-pointer"
              >
              ...
              <div className="flex flex-wrap gap-4">
                {data.image.map((img, index) => (
                  <div
                    key={img + index}
                    className="h-20 mt-1 w-20 min-w-20 bg-gray-50 border relative group"
                  >
                    <Image
                      src={img}
                      alt={img}
              ...
              <div className="flex flex-wrap gap-3">
                {data.category.map((c, index) => (
                  <div
                    ...
                    className="text-sm flex items-center gap-1 bg-gray-50 mt-2"
                  >
                    <p>{c.name}</p>
                    <div
