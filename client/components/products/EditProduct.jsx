        ...
        <section className="">
          ...
          <div className="grid p-3">
            <form className="grid gap-4" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <div>
                  <label
                    ...
                    className="bg-gray-200 h-24 border rounded flex justify-center items-center cursor-pointer"
                  >
                  ...
                  <div className="flex flex-wrap gap-4">
                    {data.image.map((img, index) => {
                      return (
                        <div
                          key={img + index}
                          className="h-20 mt-1 w-20 min-w-20 bg-gray-200 border relative group"
                        >
                          <Image
                            src={img}
                            alt={img}
                    ...
                    {data.category.map((c, index) => {
                      return (
                        <div
                          ...
                          className="text-sm flex items-center gap-1 bg-gray-200 mt-2"
                        >
                          <p>{c.name}</p>
                          <div
              ...
              <button className="bg-red-600 hover:bg-red-900 py-2 rounded-md text-white">
                {loading ? (
