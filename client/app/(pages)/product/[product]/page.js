...
export default function page() {
    ...
    const fetchProductDetails = async () => {
        try {
            setLoading(true)
            const response = await Axios({...GlobalApi.GetProductDetails , params: {productId}})
        ...
        <section className="container mx-auto p-4 grid lg:grid-cols-2">
          <div>
            <div className="bg-white lg:min-h-[65vh] lg:max-h-[65vh] rounded min-h-56 max-h-56 h-full w-full">
              <Image
                src={data.image[image] || '/assets/images/placeholder.png'}
                alt={data.name}
                width={500}
                height={500}
          ...
          <div className="p-4 lg:pl-7 text-base lg:text-lg">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 lg:gap-4">
                <div className="border border-red-600 px-4 py-2 rounded bg-red-50 w-fit">
            ...
            <h2 className="font-semibold">Why shop from Hanouti.Tn?</h2>
            <div>
              <div className="flex items-center gap-4 my-4">
                <Image src= '/assets/images/fast-delivery.png' alt="superfast delivery" width={80} height={80} />
              ...
              <div className="flex items-center gap-4 my-4">
                <Image src= '/assets/images/Best-Price.png' alt="Best prices offers" width={80} height={80} />
                <div className="text-sm">
              ...
              <div className="flex items-center gap-4 my-4">
                <Image src='/assets/images/bag.png' alt="Wide Assortment" width={80} height={80} />
                <div className="text-sm">
